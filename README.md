...
- Connected to RDS instance from EC2 using MySQL client:  mysql -h your-rds-endpoint -u admin -p
- This confirms connectivity between EC2 and RDS through properly configured Security Group
